...
export default class Knight {
    constructor(scene, x, y) {
          ...
          anims.create({
            ...
            frames: anims.generateFrameNames("atlas-knight", {
         ...
         this.sprite = scene.physics.add
            .sprite(x, y, "atlas-knight", "knight-front")
            .setSize(30, 40)
            .setOffset(10, 24);
    ...
    update(time, delta) {
        ...
        if (keyQ.isDown) {
            ...
            if (prevVelocity.x < 0) {
                sprite.setTexture("atlas-knight", "knight-left");
            } else if (prevVelocity.x > 0) { 
                sprite.setTexture("atlas-knight", "knight-right");
            } else if (prevVelocity.y < 0) { 
                sprite.setTexture("atlas-knight", "knight-back");
            } else if (prevVelocity.y > 0) {
                sprite.setTexture("atlas-knight", "knight-front");
            }
        }
